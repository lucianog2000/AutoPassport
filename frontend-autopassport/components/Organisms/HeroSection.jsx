      ...
      <Container
        ...
        <Stack
          ...
          <Text color={'gray.500'}>
            ...
            and improving the experience when buying used vehicles. 
            Overall, AutoPassport aims to improve transparency and trust in the automotive sector 
          ...
          <Stack
            ...
            <Button variant={'link'} colorScheme={'gray'} size={'m'} onClick={() => router.push('/update-nft-metadata')}>
              Update Token
            </Button>
